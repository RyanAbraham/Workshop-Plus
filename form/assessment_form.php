...
class workshop_assessment_form extends moodleform {
    ...
    public function definition() {
        ...
        if ($this->workshop->overallfeedbackmode and $this->is_editable()) {
            ...
            $mform->addElement('editor', 'feedbackauthor_editor', get_string('feedbackauthor', 'mod_workshopplus'), null,
            ...
            if ($this->workshop->overallfeedbackfiles) {
                $mform->addElement('filemanager', 'feedbackauthorattachment_filemanager',
                    get_string('feedbackauthorattachment', 'mod_workshopplus'), null,
            ...
            if ($whitelist) {
                ...
                if ($draftfiles) {
                    ...
                    if ($wrongfiles) {
                        ...
                        $errors['feedbackauthorattachment_filemanager'] = get_string('err_wrongfileextension', 'mod_workshopplus', $a);
                    }
                }
            }
        }
