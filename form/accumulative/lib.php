...
require_once(dirname(dirname(dirname(dirname(__FILE__)))) . '/workshop/form/accumulative/lib.php');
 ...
 * @return bool
 */
function workshopplusform_accumulative_pluginfile($course, $cm, $context, $filearea, array $args, $forcedownload, array $options=array()) {
    global $DB;
 ...
 */
class workshopplus_accumulative_strategy extends workshop_accumulative_strategy {
