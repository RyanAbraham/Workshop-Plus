...
class backup_workshopeval_best_subplugin extends backup_subplugin {
    ...
    protected function define_workshop_subplugin_structure() {
        ...
        $subplugintablesettings = new backup_nested_element('workshopeval_best_settings', null, array('comparison'));
        ...
        $subplugintablesettings->set_source_table('workshopeval_best_settings', array('workshopid' => backup::VAR_ACTIVITYID));
