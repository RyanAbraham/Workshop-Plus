...
require_once($CFG->dirroot . '/mod/workshopplus/allocation/random/lib.php');


// vendor\bin\phpunit workshopplusallocation_random_testcase mod\workshopplus\allocation\random\tests\allocator_test.php
class workshopplusallocation_random_testcase extends advanced_testcase {
    ...
    public function test_never_lucky() {
 ...
 */
class testable_workshopplus_random_allocator extends workshopplus_random_allocator {
    ...
    public function get_element_with_lowest_workload($workload, $gradinggrades, $pattern) {
