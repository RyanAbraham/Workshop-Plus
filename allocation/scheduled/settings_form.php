...
class workshop_scheduled_allocator_form extends workshop_random_allocator_form {
    ...
    public function definition() {
        ...
        $mform->addElement('checkbox', 'enablescheduled', get_string('enablescheduled', 'workshopallocation_scheduled'), get_string(
             'enablescheduledinfo', 'workshopallocation_scheduled'), 1);
