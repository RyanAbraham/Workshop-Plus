...
class restore_workshop_activity_structure_step extends restore_activity_structure_step {
    ...
    protected function after_execute() {
        ...
        $this->add_related_files('mod_workshopplus', 'submission_content', 'workshop_examplesubmission');
        $this->add_related_files('mod_workshopplus', 'submission_attachment', 'workshop_examplesubmission');

        // Add reference assessment related files, matching by 'workshop_referenceassessment' itemname
        $this->add_related_files('mod_workshopplus', 'overallfeedback_content', 'workshop_referenceassessment');
        $this->add_related_files('mod_workshopplus', 'overallfeedback_attachment', 'workshop_referenceassessment');

        // Add example assessment related files, matching by 'workshop_exampleassessment' itemname
        $this->add_related_files('mod_workshopplus', 'overallfeedback_content', 'workshop_exampleassessment');
        $this->add_related_files('mod_workshopplus', 'overallfeedback_attachment', 'workshop_exampleassessment');

        // Add submission related files, matching by 'workshop_submission' itemname
        $this->add_related_files('mod_workshopplus', 'submission_content', 'workshop_submission');
        $this->add_related_files('mod_workshopplus', 'submission_attachment', 'workshop_submission');

        // Add assessment related files, matching by 'workshop_assessment' itemname
        $this->add_related_files('mod_workshopplus', 'overallfeedback_content', 'workshop_assessment');
        $this->add_related_files('mod_workshopplus', 'overallfeedback_attachment', 'workshop_assessment');
    }
}
