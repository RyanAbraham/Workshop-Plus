...
/**
 * Defines all the backup steps that will be used by {@link backup_workshopplus_activity_task}
 *
 ...
 */
class backup_workshopplus_activity_structure_step extends backup_activity_structure_step {

    /**
     * Defines the structure of the 'workshopplus' element inside the workshop.xml file
     *
    ...
    protected function define_structure() {
        ...
        $workshop = new backup_nested_element('workshopplus', array('id'), array(
        ...
        $workshop->set_source_table('workshopplus', array('id' => backup::VAR_ACTIVITYID));
        ...
        if ($userinfo) {
            ...
            $assessment->set_source_table('workshopplus_assessments', array('submissionid' => backup::VAR_PARENTID));

            $aggregation->set_source_table('workshopplus_aggregations', array('workshopid' => backup::VAR_PARENTID));
        }
        ...
        $workshop->annotate_files('mod_workshopplus', 'intro', null); // no itemid used
        $workshop->annotate_files('mod_workshopplus', 'instructauthors', null); // no itemid used
        $workshop->annotate_files('mod_workshopplus', 'instructreviewers', null); // no itemid used
        $workshop->annotate_files('mod_workshopplus', 'conclusion', null); // no itemid used

        $examplesubmission->annotate_files('mod_workshopplus', 'submission_content', 'id');
        $examplesubmission->annotate_files('mod_workshopplus', 'submission_attachment', 'id');

        $referenceassessment->annotate_files('mod_workshopplus', 'overallfeedback_content', 'id');
        $referenceassessment->annotate_files('mod_workshopplus', 'overallfeedback_attachment', 'id');

        $exampleassessment->annotate_files('mod_workshopplus', 'overallfeedback_content', 'id');
        $exampleassessment->annotate_files('mod_workshopplus', 'overallfeedback_attachment', 'id');

        $submission->annotate_files('mod_workshopplus', 'submission_content', 'id');
        $submission->annotate_files('mod_workshopplus', 'submission_attachment', 'id');

        $assessment->annotate_files('mod_workshopplus', 'overallfeedback_content', 'id');
        $assessment->annotate_files('mod_workshopplus', 'overallfeedback_attachment', 'id');
