...
require_once($CFG->dirroot . '/mod/workshop/backup/moodle2/restore_workshopplus_stepslib.php'); // Because it exists (must)
...
class restore_workshopplus_activity_task extends restore_activity_task {
    ...
    protected function define_my_steps() {
        ...
        $this->add_step(new restore_workshopplus_activity_structure_step('workshopplus_structure', 'workshop.xml'));
    }
    ...
    static public function define_restore_log_rules() {
        ...
        $rules[] = new restore_log_rule('workshopplus', 'add', 'view.php?id={course_module}', '{workshop}');
        $rules[] = new restore_log_rule('workshopplus', 'update', 'view.php?id={course_module}', '{workshop}');
        $rules[] = new restore_log_rule('workshopplus', 'view', 'view.php?id={course_module}', '{workshop}');
        ...
        $rules[] = new restore_log_rule('workshopplus', 'update aggregate grades', 'view.php?id={course_module}', '{workshop}');
        $rules[] = new restore_log_rule('workshopplus', 'update switch phase', 'view.php?id={course_module}', '[phase]');
        $rules[] = new restore_log_rule('workshopplus', 'update clear aggregated grades', 'view.php?id={course_module}', '{workshop}');
        $rules[] = new restore_log_rule('workshopplus', 'update clear assessments', 'view.php?id={course_module}', '{workshop}');
